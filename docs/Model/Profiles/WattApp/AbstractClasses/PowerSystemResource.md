...
classDiagram
    ...
    click PowerSystemResource href "/CIM/Profiles/WattApp/AbstractClasses/PowerSystemResource/"
    style PowerSystemResource fill:#006400,stroke:#333,stroke-width:2px,rx:10,ry:10,color:#FFFFFF
        ...
        IdentifiedObject <|-- PowerSystemResource : inherits
            click IdentifiedObject href "/CIM/Profiles/WattApp/AbstractClasses/IdentifiedObject/"
            style IdentifiedObject rx:10,ry:10

        Feature <|-- PowerSystemResource : inherits
            click Feature href "/AviationObstacle/Feature/"
            style Feature fill:#FF8C00,stroke:#333,stroke-width:2px,rx:10,ry:10,color:#FFFFFF
        ...
        LocationMethodKind
            ...
            style LocationMethodKind fill:#FF1493,stroke:#333,stroke-width:2px,rx:10,ry:10,color:#FFFFFF

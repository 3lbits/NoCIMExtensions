...
classDiagram
    ...
    style CableInfo fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        MultiCoreCableInfo
            ...
            style MultiCoreCableInfo fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

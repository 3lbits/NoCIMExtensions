...
classDiagram
    ...
    style InsulationLayer fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        WireInsulationKind
            ...
            style WireInsulationKind fill:#5729FF,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

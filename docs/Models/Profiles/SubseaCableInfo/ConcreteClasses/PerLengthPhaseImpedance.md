...
classDiagram
    ...
    style PerLengthPhaseImpedance fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PerLengthImpedance <|-- PerLengthPhaseImpedance : inherits
            ...
            style PerLengthImpedance fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PhaseImpedanceData
            ...
            style PhaseImpedanceData fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

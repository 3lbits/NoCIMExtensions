...
classDiagram
    ...
    style PerLengthImpedance fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PerLengthPhaseImpedance
            ...
            style PerLengthPhaseImpedance fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PerLengthSequenceImpedance
            ...
            style PerLengthSequenceImpedance fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PerLengthConductorParameter <|-- PerLengthImpedance : inherits
            ...
            style PerLengthConductorParameter fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        ConductorInfo
            ...
            style ConductorInfo fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

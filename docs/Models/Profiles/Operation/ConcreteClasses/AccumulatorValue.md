...
| ---  | --- | --- | --- | --- |
| Accumulator | [cim:AccumulatorValue.Accumulator](http://iec.ch/TC57/CIM100#AccumulatorValue.Accumulator) | No cardinality available Accumulator | Measurement to which this value is connected. | direct |
| AccumulatorReset | [cim:AccumulatorValue.AccumulatorReset](http://iec.ch/TC57/CIM100#AccumulatorValue.AccumulatorReset) | No cardinality available AccumulatorReset | The command that resets the accumulator value. | direct |

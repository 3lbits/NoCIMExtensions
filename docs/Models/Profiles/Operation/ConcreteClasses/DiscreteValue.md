...
classDiagram
    ...
    style DiscreteValue fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| Command | [cim:DiscreteValue.Command](http://iec.ch/TC57/CIM100#DiscreteValue.Command) | No cardinality available Command | The Control variable associated with the MeasurementValue. | direct |
| Discrete | [cim:DiscreteValue.Discrete](http://iec.ch/TC57/CIM100#DiscreteValue.Discrete) | No cardinality available Discrete | Measurement to which this value is connected. | direct |

...
classDiagram
    ...
    style SetPoint fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| normalValue | [cim:SetPoint.normalValue](http://iec.ch/TC57/CIM100#SetPoint.normalValue) | No cardinality available float | Normal value for Control.value e.g. used for percentage scaling. | direct |
| value | [cim:SetPoint.value](http://iec.ch/TC57/CIM100#SetPoint.value) | No cardinality available float | The value representing the actuator output. | direct |

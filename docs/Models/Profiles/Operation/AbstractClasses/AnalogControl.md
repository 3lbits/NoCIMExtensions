...
classDiagram
    ...
    style AnalogControl fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        RaiseLowerCommand
            ...
            style RaiseLowerCommand fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        AnalogControl <|-- SetPoint : inherits

        SetPoint
            click SetPoint href "/Models/Profiles/Operation/ConcreteClasses/SetPoint/"
            style SetPoint fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

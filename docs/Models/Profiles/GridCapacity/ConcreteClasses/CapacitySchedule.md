...
classDiagram
    ...
    style CapacitySchedule fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        BaseIrregularTimeSeries <|-- CapacitySchedule : inherits
            ...
            style BaseIrregularTimeSeries fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        Feeder
            ...
            style Feeder fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        CapacityTimePoint
            ...
            style CapacityTimePoint fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

...
classDiagram
    ...
    style AuxiliaryEquipment fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        FaultIndicator
            ...
            style FaultIndicator fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        SurgeArrester
            ...
            style SurgeArrester fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        AuxiliaryEquipment <|-- WaveTrap : inherits

        WaveTrap
            click WaveTrap href "/Models/Profiles/CoreEquipment/ConcreteClasses/WaveTrap/"
            style WaveTrap fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

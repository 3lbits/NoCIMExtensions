...
classDiagram
    ...
    click ShuntCompensator href "/Models/Profiles/CoreEquipment/AbstractClasses/ShuntCompensator/"
    style ShuntCompensator fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        LinearShuntCompensator
            ...
            style LinearShuntCompensator fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        NonlinearShuntCompensator
            ...
            style NonlinearShuntCompensator fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| aVRDelay | [cim:ShuntCompensator.aVRDelay](http://iec.ch/TC57/CIM100#ShuntCompensator.aVRDelay) | No cardinality available Seconds | An automatic voltage regulation delay (AVRDelay) which is the time delay from a change in voltage to when the capacitor is allowed to change state. This filters out temporary changes in voltage. | direct |
| grounded | [cim:ShuntCompensator.grounded](http://iec.ch/TC57/CIM100#ShuntCompensator.grounded) | No cardinality available boolean | Used for Yn and Zn connections. True if the neutral is solidly grounded. | direct |
| maximumSections | [cim:ShuntCompensator.maximumSections](http://iec.ch/TC57/CIM100#ShuntCompensator.maximumSections) | No cardinality available integer | The maximum number of sections that may be switched in. | direct |
| nomU | [cim:ShuntCompensator.nomU](http://iec.ch/TC57/CIM100#ShuntCompensator.nomU) | No cardinality available Voltage | The voltage at which the nominal reactive power may be calculated. This should normally be within 10% of the voltage at which the capacitor is connected to the network. | direct |
| normalSections | [cim:ShuntCompensator.normalSections](http://iec.ch/TC57/CIM100#ShuntCompensator.normalSections) | No cardinality available integer | The normal number of sections switched in. The value shall be between zero and ShuntCompensator.maximumSections. | direct |
| voltageSensitivity | [cim:ShuntCompensator.voltageSensitivity](http://iec.ch/TC57/CIM100#ShuntCompensator.voltageSensitivity) | No cardinality available VoltagePerReactivePower | Voltage sensitivity required for the device to regulate the bus voltage, in voltage/reactive power. | direct |

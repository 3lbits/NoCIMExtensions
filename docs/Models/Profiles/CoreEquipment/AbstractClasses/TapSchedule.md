...
classDiagram
    ...
    style TapSchedule fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| TapChanger | [cim:TapSchedule.TapChanger](http://iec.ch/TC57/CIM100#TapSchedule.TapChanger) | No cardinality available TapChanger | A TapSchedule is associated with a TapChanger. | direct |

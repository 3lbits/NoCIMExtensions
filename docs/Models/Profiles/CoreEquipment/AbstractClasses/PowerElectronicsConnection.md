...
classDiagram
    ...
    style PowerElectronicsConnection fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
     
        RegulatingCondEq <|-- PowerElectronicsConnection : inherits
        ...
        PowerElectronicsUnit
            ...
            style PowerElectronicsUnit fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| maxQ | [cim:PowerElectronicsConnection.maxQ](http://iec.ch/TC57/CIM100#PowerElectronicsConnection.maxQ) | No cardinality available ReactivePower | Maximum reactive power limit. This is the maximum (nameplate) limit for the unit. | direct |
| minQ | [cim:PowerElectronicsConnection.minQ](http://iec.ch/TC57/CIM100#PowerElectronicsConnection.minQ) | No cardinality available ReactivePower | Minimum reactive power limit for the unit. This is the minimum (nameplate) limit for the unit. | direct |
| ratedS | [cim:PowerElectronicsConnection.ratedS](http://iec.ch/TC57/CIM100#PowerElectronicsConnection.ratedS) | No cardinality available ApparentPower | Nameplate apparent power rating for the unit.
The attribute shall have a positive value. | direct |
| ratedU | [cim:PowerElectronicsConnection.ratedU](http://iec.ch/TC57/CIM100#PowerElectronicsConnection.ratedU) | No cardinality available Voltage | Rated voltage (nameplate data, Ur in IEC 60909-0). It is primarily used for short circuit data exchange according to IEC 60909.
The attribute shall be a positive value. | direct |
| PowerElectronicsUnit | [cim:PowerElectronicsConnection.PowerElectronicsUnit](http://iec.ch/TC57/CIM100#PowerElectronicsConnection.PowerElectronicsUnit) | No cardinality available PowerElectronicsUnit | An AC network connection may have several power electronics units connecting through it. | direct |

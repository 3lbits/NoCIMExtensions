...
classDiagram
    ...
    style Connector fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        Connector <|-- BusbarSection : inherits

        BusbarSection
            click BusbarSection href "/Models/Profiles/CoreEquipment/ConcreteClasses/BusbarSection/"
            style BusbarSection fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        Connector <|-- Junction : inherits

        Junction
            click Junction href "/Models/Profiles/CoreEquipment/ConcreteClasses/Junction/"
            style Junction fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

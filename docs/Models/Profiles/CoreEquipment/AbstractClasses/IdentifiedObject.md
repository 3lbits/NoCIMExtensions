...
classDiagram
    ...
    style IdentifiedObject fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        BusNameMarker
            ...
            style BusNameMarker fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        ControlAreaGeneratingUnit
            ...
            style ControlAreaGeneratingUnit fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        DayType
            ...
            style DayType fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        EnergySchedulingType
            ...
            style EnergySchedulingType fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        IdentifiedObject <|-- FossilFuel : inherits

        FossilFuel
            click FossilFuel href "/Models/Profiles/CoreEquipment/ConcreteClasses/FossilFuel/"
            style FossilFuel fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        GeographicalRegion
            ...
            style GeographicalRegion fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        LoadResponseCharacteristic
            ...
            style LoadResponseCharacteristic fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        OperationalLimitSet
            ...
            style OperationalLimitSet fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        OperationalLimitType
            ...
            style OperationalLimitType fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PhaseTapChangerTable
            ...
            style PhaseTapChangerTable fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        RatioTapChangerTable
            ...
            style RatioTapChangerTable fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        Season
            ...
            style Season fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        SubGeographicalRegion
            ...
            style SubGeographicalRegion fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        IdentifiedObject <|-- TieFlow : inherits

        TieFlow
            click TieFlow href "/Models/Profiles/CoreEquipment/ConcreteClasses/TieFlow/"
            style TieFlow fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        TransformerEnd
            ...
            style TransformerEnd fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

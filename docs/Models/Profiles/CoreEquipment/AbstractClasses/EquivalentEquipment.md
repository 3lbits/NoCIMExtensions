...
classDiagram
    ...
    style EquivalentEquipment fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        EquivalentBranch
            ...
            style EquivalentBranch fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        EquivalentInjection
            ...
            style EquivalentInjection fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        EquivalentShunt
            ...
            style EquivalentShunt fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

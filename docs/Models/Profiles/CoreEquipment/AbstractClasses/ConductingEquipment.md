...
classDiagram
    ...
    style ConductingEquipment fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        Clamp
            ...
            style Clamp fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        Ground
            ...
            style Ground fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

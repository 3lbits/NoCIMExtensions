...
classDiagram
    class Sensor
    click Sensor href "/Models/Profiles/CoreEquipment/AbstractClasses/Sensor/"
    style Sensor fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        Sensor <|-- CurrentTransformer : inherits

        CurrentTransformer
            click CurrentTransformer href "/Models/Profiles/CoreEquipment/ConcreteClasses/CurrentTransformer/"
            style CurrentTransformer fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        Sensor <|-- PostLineSensor : inherits

        PostLineSensor
            click PostLineSensor href "/Models/Profiles/CoreEquipment/ConcreteClasses/PostLineSensor/"
            style PostLineSensor fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        Sensor <|-- PotentialTransformer : inherits

        PotentialTransformer
            click PotentialTransformer href "/Models/Profiles/CoreEquipment/ConcreteClasses/PotentialTransformer/"
            style PotentialTransformer fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| Terminal | [cim:AuxiliaryEquipment.Terminal](http://iec.ch/TC57/CIM100#AuxiliaryEquipment.Terminal) | No cardinality available Terminal | The Terminal at the equipment where the AuxiliaryEquipment is attached. | AuxiliaryEquipment |

...
| ---  | --- | --- | --- | --- |
| ConformLoadSchedules | [cim:ConformLoadGroup.ConformLoadSchedules](http://iec.ch/TC57/CIM100#ConformLoadGroup.ConformLoadSchedules) | No cardinality available ConformLoadSchedule | The ConformLoadSchedules in the ConformLoadGroup. | direct |
| EnergyConsumers | [cim:ConformLoadGroup.EnergyConsumers](http://iec.ch/TC57/CIM100#ConformLoadGroup.EnergyConsumers) | No cardinality available ConformLoad | Conform loads assigned to this ConformLoadGroup. | direct |

...
classDiagram
    ...
    style HydroGeneratingUnit fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        HydroEnergyConversionKind
            ...
            style HydroEnergyConversionKind fill:#5729FF,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        HydroTurbineKind
            ...
            style HydroTurbineKind fill:#5729FF,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

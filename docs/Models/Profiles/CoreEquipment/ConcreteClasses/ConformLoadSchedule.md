...
classDiagram
    ...
    style ConformLoadSchedule fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| ConformLoadGroup | [cim:ConformLoadSchedule.ConformLoadGroup](http://iec.ch/TC57/CIM100#ConformLoadSchedule.ConformLoadGroup) | No cardinality available ConformLoadGroup | The ConformLoadGroup where the ConformLoadSchedule belongs. | direct |

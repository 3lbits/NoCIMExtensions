...
classDiagram
    ...
    style ApparentPowerLimit fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| normalValue | [cim:ApparentPowerLimit.normalValue](http://iec.ch/TC57/CIM100#ApparentPowerLimit.normalValue) | No cardinality available ApparentPower | The normal apparent power limit. The attribute shall be a positive value or zero. | direct |

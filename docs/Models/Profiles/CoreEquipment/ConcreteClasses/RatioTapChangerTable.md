...
| ---  | --- | --- | --- | --- |
| RatioTapChanger | [cim:RatioTapChangerTable.RatioTapChanger](http://iec.ch/TC57/CIM100#RatioTapChangerTable.RatioTapChanger) | No cardinality available RatioTapChanger | The ratio tap changer of this tap ratio table. | direct |
| RatioTapChangerTablePoint | [cim:RatioTapChangerTable.RatioTapChangerTablePoint](http://iec.ch/TC57/CIM100#RatioTapChangerTable.RatioTapChangerTablePoint) | No cardinality available RatioTapChangerTablePoint | Points of this table. | direct |

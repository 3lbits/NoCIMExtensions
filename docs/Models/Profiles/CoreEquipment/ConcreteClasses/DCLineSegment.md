...
classDiagram
    ...
    style DCLineSegment fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| capacitance | [cim:DCLineSegment.capacitance](http://iec.ch/TC57/CIM100#DCLineSegment.capacitance) | No cardinality available Capacitance | Capacitance of the DC line segment. Significant for cables only. | direct |
| inductance | [cim:DCLineSegment.inductance](http://iec.ch/TC57/CIM100#DCLineSegment.inductance) | No cardinality available Inductance | Inductance of the DC line segment. Negligible compared with DCSeriesDevice used for smoothing. | direct |
| resistance | [cim:DCLineSegment.resistance](http://iec.ch/TC57/CIM100#DCLineSegment.resistance) | No cardinality available Resistance | Resistance of the DC line segment. | direct |
| length | [cim:DCLineSegment.length](http://iec.ch/TC57/CIM100#DCLineSegment.length) | No cardinality available Length | Segment length for calculating line section capabilities. | direct |

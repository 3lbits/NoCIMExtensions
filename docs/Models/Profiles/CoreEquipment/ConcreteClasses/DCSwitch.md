...
classDiagram
    ...
    style DCSwitch fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        DCSwitch <|-- DCBreaker : inherits

        DCBreaker
            click DCBreaker href "/Models/Profiles/CoreEquipment/ConcreteClasses/DCBreaker/"
            style DCBreaker fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

        DCSwitch <|-- DCDisconnector : inherits

        DCDisconnector
            click DCDisconnector href "/Models/Profiles/CoreEquipment/ConcreteClasses/DCDisconnector/"
            style DCDisconnector fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

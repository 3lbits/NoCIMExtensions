...
| ---  | --- | --- | --- | --- |
| Regions | [cim:GeographicalRegion.Regions](http://iec.ch/TC57/CIM100#GeographicalRegion.Regions) | No cardinality available SubGeographicalRegion | All sub-geographical regions within this geographical region. | direct |

...
| ---  | --- | --- | --- | --- |
| InitialReactiveCapabilityCurve | [cim:SynchronousMachine.InitialReactiveCapabilityCurve](http://iec.ch/TC57/CIM100#SynchronousMachine.InitialReactiveCapabilityCurve) | No cardinality available ReactiveCapabilityCurve | The default reactive capability curve for use by a synchronous machine. | direct |
| maxQ | [cim:SynchronousMachine.maxQ](http://iec.ch/TC57/CIM100#SynchronousMachine.maxQ) | No cardinality available ReactivePower | Maximum reactive power limit. This is the maximum (nameplate) limit for the unit. | direct |
| minQ | [cim:SynchronousMachine.minQ](http://iec.ch/TC57/CIM100#SynchronousMachine.minQ) | No cardinality available ReactivePower | Minimum reactive power limit for the unit. | direct |
| qPercent | [cim:SynchronousMachine.qPercent](http://iec.ch/TC57/CIM100#SynchronousMachine.qPercent) | No cardinality available PerCent | Part of the coordinated reactive control that comes from this machine. The attribute is used as a participation factor not necessarily summing up to 100% for the participating devices in the control. | direct |
| type | [cim:SynchronousMachine.type](http://iec.ch/TC57/CIM100#SynchronousMachine.type) | No cardinality available SynchronousMachineKind | Modes that this synchronous machine can operate in. | direct |

...
classDiagram
    ...
    style NonConformLoad fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| LoadGroup | [cim:NonConformLoad.LoadGroup](http://iec.ch/TC57/CIM100#NonConformLoad.LoadGroup) | No cardinality available NonConformLoadGroup | Group of this ConformLoad. | direct |

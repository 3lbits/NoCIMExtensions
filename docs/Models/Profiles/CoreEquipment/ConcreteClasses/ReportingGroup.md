...
| ---  | --- | --- | --- | --- |
| BusNameMarker | [cim:ReportingGroup.BusNameMarker](http://iec.ch/TC57/CIM100#ReportingGroup.BusNameMarker) | No cardinality available BusNameMarker | The bus name markers that belong to this reporting group. | direct |

...
classDiagram
    ...
    style WindPowerPlant fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        WindGeneratingUnit
            ...
            style WindGeneratingUnit fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| WindGeneratingUnits | [eu:WindPowerPlant.WindGeneratingUnits](http://iec.ch/TC57/CIM100-European#WindPowerPlant.WindGeneratingUnits) | No cardinality available WindGeneratingUnit | A wind generating unit or units may be a member of a wind power plant. | direct |

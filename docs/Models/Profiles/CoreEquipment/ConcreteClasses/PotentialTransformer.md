...
classDiagram
    ...
    style PotentialTransformer fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
     
        Sensor <|-- PotentialTransformer : inherits
            click Sensor href "/Models/Profiles/CoreEquipment/AbstractClasses/Sensor/"
            style Sensor fill:#4169E1,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white

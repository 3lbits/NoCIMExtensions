...
classDiagram
    ...
    style CAESPlant fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| ThermalGeneratingUnit | [cim:CAESPlant.ThermalGeneratingUnit](http://iec.ch/TC57/CIM100#CAESPlant.ThermalGeneratingUnit) | No cardinality available ThermalGeneratingUnit | A thermal generating unit may be a member of a compressed air energy storage plant. | direct |

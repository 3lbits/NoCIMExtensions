...
| ---  | --- | --- | --- | --- |
| DCTerminals | [cim:DCNode.DCTerminals](http://iec.ch/TC57/CIM100#DCNode.DCTerminals) | No cardinality available DCBaseTerminal | DC base terminals interconnected with zero impedance at a this DC connectivity node. | direct |
| DCEquipmentContainer | [cim:DCNode.DCEquipmentContainer](http://iec.ch/TC57/CIM100#DCNode.DCEquipmentContainer) | No cardinality available DCEquipmentContainer | The DC container for the DC nodes. | direct |

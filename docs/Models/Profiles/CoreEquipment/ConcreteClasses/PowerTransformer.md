...
classDiagram
    ...
    style PowerTransformer fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        PowerTransformerEnd
            ...
            style PowerTransformerEnd fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| PowerTransformerEnd | [cim:PowerTransformer.PowerTransformerEnd](http://iec.ch/TC57/CIM100#PowerTransformer.PowerTransformerEnd) | No cardinality available PowerTransformerEnd | The ends of this power transformer. | direct |

...
| ---  | --- | --- | --- | --- |
| SolarGeneratingUnits | [eu:SolarPowerPlant.SolarGeneratingUnits](http://iec.ch/TC57/CIM100-European#SolarPowerPlant.SolarGeneratingUnits) | No cardinality available SolarGeneratingUnit | A solar generating unit or units may be a member of a solar power plant. | direct |

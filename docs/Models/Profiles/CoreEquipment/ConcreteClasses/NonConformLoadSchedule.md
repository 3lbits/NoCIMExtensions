...
classDiagram
    ...
    style NonConformLoadSchedule fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        NonConformLoadGroup
            ...
            style NonConformLoadGroup fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| NonConformLoadGroup | [cim:NonConformLoadSchedule.NonConformLoadGroup](http://iec.ch/TC57/CIM100#NonConformLoadSchedule.NonConformLoadGroup) | No cardinality available NonConformLoadGroup | The NonConformLoadGroup where the NonConformLoadSchedule belongs. | direct |

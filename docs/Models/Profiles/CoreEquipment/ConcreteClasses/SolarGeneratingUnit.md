...
classDiagram
    ...
    style SolarGeneratingUnit fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
        ...
        SolarPowerPlant
            ...
            style SolarPowerPlant fill:#00D156,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| SolarPowerPlant | [eu:SolarGeneratingUnit.SolarPowerPlant](http://iec.ch/TC57/CIM100-European#SolarGeneratingUnit.SolarPowerPlant) | No cardinality available SolarPowerPlant | A solar power plant may have solar generating units. | direct |

...
classDiagram
    ...
    style BatteryUnit fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| ratedE | [cim:BatteryUnit.ratedE](http://iec.ch/TC57/CIM100#BatteryUnit.ratedE) | No cardinality available RealEnergy | Full energy storage capacity of the battery. The attribute shall be a positive value. | direct |

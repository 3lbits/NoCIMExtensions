...
classDiagram
    ...
    style DCGround fill:#163289,stroke:#1F2A37,stroke-width:2px,rx:10,ry:10,color:white
...
| ---  | --- | --- | --- | --- |
| inductance | [cim:DCGround.inductance](http://iec.ch/TC57/CIM100#DCGround.inductance) | No cardinality available Inductance | Inductance to ground. | direct |
| r | [cim:DCGround.r](http://iec.ch/TC57/CIM100#DCGround.r) | No cardinality available Resistance | Resistance to ground. | direct |

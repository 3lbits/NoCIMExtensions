...
**URI**: [cim:Fuse](https://cim.ucaiug.io/ns#Fuse)<br />
**Type**: Class
...
classDiagram
    class Fuse
    click Fuse href "/Models/Profiles/Equipment/ConcreteClasses/Fuse/"
    style Fuse fill:#102820,stroke:#333,stroke-width:2px,rx:10,ry:10,color:white

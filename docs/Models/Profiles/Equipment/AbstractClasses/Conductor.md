...
classDiagram
    ...
    style Conductor fill:#102820,stroke:#333,stroke-width:2px,rx:10,ry:10,color:white
        ...
        ACLineSegment
            click ACLineSegment href "/Models/Profiles/Equipment/ConcreteClasses/ACLineSegment/"
...
| ---  | --- | --- | --- | --- |
| length | [cim:Conductor.length](https://cim.ucaiug.io/ns#Conductor.length) | 0..1 Length | Segment length for calculating line section capabilities. | direct |
